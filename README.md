...
# 3. OmniTunnel CLI
cd /tmp && wget https://github.com/RadouaneElarfaoui/omnitunnel-cli/releases/download/v1.1.2/omnitunnel-cli_1.1.2.deb && sudo apt install -y ./omnitunnel-cli_1.1.2.deb
