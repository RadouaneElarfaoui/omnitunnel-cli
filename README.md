...
# 2. OmniTunnel CLI
curl -fL -o /tmp/omnitunnel-cli_2.0.deb https://github.com/RadouaneElarfaoui/omnitunnel-cli/releases/download/v2.0/omnitunnel-cli_2.0.deb && sudo apt install -y /tmp/omnitunnel-cli_2.0.deb
```
### Manual installation
